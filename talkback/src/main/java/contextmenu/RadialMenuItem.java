...
public class RadialMenuItem extends ContextMenuItem {
  ...
  public interface OnMenuItemSelectionListener {
    /**
     * Called when a menu item has been selected. This is the first code that is executed; if it
     * returns true, no other callbacks will be executed.
     *
     * @param item The menu item that was selected.
     * @return {@code true} to consume this selection event and prevent other listeners from
     *     executing.
     */
