      ...
      case NODE_CAPTION_TEXT:
        {
          ...
          if (ocrText != null) {
            if (iconLabel != null) {
              return mContext.getString(R.string.detected_image_label, iconLabel, ocrText);
            } else {
              return mContext.getString(R.string.character_recognition_text, ocrText);
            }
          } else if (iconLabel != null) {
            return mContext.getString(R.string.detected_icon_label, iconLabel);
          }
          return "";
        }
      default:
