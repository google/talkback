...
/** Activity used to set TalkBack focus indicator preferences. */
public class TalkBackFocusIndicatorPreferenceActivity extends PreferencesActivity {
   ...
   */
  public static class FocusIndicatorPrefFragment extends TalkbackBaseFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
      ...
      if (getActivity() == null || !FeatureSupport.supportCustomizingFocusIndicator()) {
        return;
      }
      prefs = SharedPreferencesUtils.getSharedPreferences(getActivity());
        ...
        for (FocusIndicatorPref source : FocusIndicatorPref.values()) {
          if (TextUtils.equals(prefTitle, getString(source.getTitleId()))) {
            SharedPreferencesUtils.putIntPref(
                prefs,
                getResources(),
                R.string.pref_border_color_key,
                getColor(source.getColorId()));
            break;
          }
        }
      }
    ...
    private void initBorderColorPref() {
      ...
      int focusIndicatorColor =
          FocusIndicatorUtils.getTalkBackFocusColor(getActivity(), prefs, getResources());
      for (FocusIndicatorPref source : FocusIndicatorPref.values()) {
