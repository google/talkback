...
public class KeyComboModelApp implements KeyComboModel {
  ...
  public KeyComboModelApp(Context context) {
    ...
    persister = new KeyComboPersister(this.context, null /* no prefix */);
    loadCombos();
  }
  ...
  private void loadCombos() {
    addCombo(context.getString(R.string.keycombo_shortcut_navigate_next));
    addCombo(context.getString(R.string.keycombo_shortcut_navigate_previous));
