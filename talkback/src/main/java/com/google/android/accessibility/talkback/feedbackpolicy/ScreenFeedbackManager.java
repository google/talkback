...
public class ScreenFeedbackManager
  ...
  protected final @Nullable ProcessorAccessibilityHints accessibilityHintsManager;
  ...
  public ScreenFeedbackManager(
      ...
      @Nullable ProcessorAccessibilityHints hintsManager,
  ...
  static class FeedbackComposer {
    ...
    private CharSequence formatAnnouncementForArc(
    ...
    private CharSequence getHintForArc(AllContext allContext, final int logDepth) {
