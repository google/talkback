...
import com.android.switchaccess.RowColumnTreeBuilder;
...
public class RowColumnTreeBuilderTest {
    ...
    private RowColumnTreeBuilder mRowColumnTreeBuilder = new RowColumnTreeBuilder();
    ...
    public void setUp() {
        ...
        mN12 = new SwitchAccessNodeCompat(AccessibilityNodeInfo.obtain());
    ...
    public void buildTreeWithNoActions_treeHasOnlyClearFocusNode() {
        ...
        OptionScanNode tree = mRowColumnTreeBuilder.buildTreeFromNodeTree(mN0, null);
    ...
    public void buildTreeWithTwoRows_hasExpectedStructure() {
        ...
        OptionScanNode treeRoot = mRowColumnTreeBuilder
                .buildTreeFromNodeTree(mRoot0, new GlobalActionNode(0, null, "global action label"));
    ...
    public void buildTreeWithContainer_hasExpectedStructure() {
        ...
        OptionScanNode treeRoot = mRowColumnTreeBuilder.buildTreeFromNodeTree(
