...
public class FeedbackItem {
   ...
   */
  public static final int FLAG_FORCED_FEEDBACK = 0x4;
  ...
  public static final int FLAG_NO_DEVICE_SLEEP = 0x100;
  ...
  /**
   * {@link SpeechController.UtteranceStartRunnable} to be fired before feedback from this item
   * starts.
   */
  private SpeechController.UtteranceStartRunnable mStartAction;

  /**
   * {@link SpeechController.UtteranceRangeStartCallback} to be invoked to update the range of
   * utterance being spoken.
   */
  private SpeechController.UtteranceRangeStartCallback mRangeStartCallback;

  /**
   * {@link SpeechController.UtteranceCompleteRunnable} to be fired when feedback from this item is
   * complete.
   */
  private SpeechController.UtteranceCompleteRunnable mCompletedAction;

  public FeedbackItem(EventId eventId) {
  ...
  /** @return the {@link SpeechController.UtteranceStartRunnable} associated with this item */
  public SpeechController.UtteranceStartRunnable getStartAction() {
    return mStartAction;
  }

  /** @return the {@link SpeechController.UtteranceRangeStartCallback} associated with this item */
   ...
   */
  public void setStartAction(SpeechController.UtteranceStartRunnable action) {
    mStartAction = action;
  }

  /**
   * Replaces the existing {@link SpeechController.UtteranceRangeStartCallback} of this item.
   *
   * @param callback The callback to set
   */
  public void setRangeStartCallback(SpeechController.UtteranceRangeStartCallback callback) {
