...
public class KeyComboModelApp implements KeyComboModel {
  ...
  private void loadCombos() {
    ...
    addCombo(mContext.getString(R.string.keycombo_shortcut_other_talkback_context_menu));
  ...
  public void updateVersion(int previousVersion) {
    ...
    if (previousVersion < 40500000) {
      ...
      updateKeyCombo(
          mContext.getString(R.string.keycombo_shortcut_other_talkback_context_menu),
