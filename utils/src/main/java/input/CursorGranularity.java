...
public enum CursorGranularity {
  ...
  CHARACTER(
      R.string.granularity_character, AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_CHARACTER),
  ...
  PARAGRAPH(
      R.string.granularity_paragraph, AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_PARAGRAPH),
