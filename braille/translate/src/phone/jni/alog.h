...
#ifndef JAVA_COM_GOOGLE_ANDROID_ACCESSIBILITY_BRAILLE_TRANSLATE_JNI_ALOG_H_
#define JAVA_COM_GOOGLE_ANDROID_ACCESSIBILITY_BRAILLE_TRANSLATE_JNI_ALOG_H_
...
#endif  // JAVA_COM_GOOGLE_ANDROID_ACCESSIBILITY_BRAILLE_TRANSLATE_JNI_ALOG_H_
