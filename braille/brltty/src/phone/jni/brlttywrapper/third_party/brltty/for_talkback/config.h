 ...
 */
/*
 * NOTE: This file was generated on Linux using ./cfg-android.
 */
...
#define PACKAGE_COPYRIGHT "© 1995-2019 by The BRLTTY Developers"
...
/* Define this to be a string containing the path to the LibLouis tables
 * directory. */
...
#define BRAILLE_DRIVER_CODES                                                 \
  ...
  "ec hd lt mb mn tn ts vd vs"
/* Define this to be a string containing the default parameters for the braille
 * driver(s). */
...
/* Define this to be a string containing the default parameters for the speech
 * driver(s). */
...
/* Define this to be a string containing the default parameters for the screen
 * driver(s). */
...
#define ENABLE_API 1
/* Define this to be a string containing the default parameters for the
