...
public class ContentHelper {
  ...
  public DisplayInfo generateDisplayInfo(
    ...
    TranslationResult translationResult =
        TranslateHelper.translateCurrentContent(
            translatorManager.getOutputTranslator(), NO_CURSOR, text);
   ...
   * the display info.
   */
  public DisplayInfo panLeft(Source source) {
    WrapStrategy wrapStrategy = wrapStrategyRetriever.getWrapStrategy();
    return wrapStrategy.panLeft()
        ? getDisplayInfo(
   ...
   * the display info.
   */
  public DisplayInfo panRight(Source source) {
    WrapStrategy wrapStrategy = wrapStrategyRetriever.getWrapStrategy();
    return wrapStrategy.panRight()
        ? getDisplayInfo(
            currentTranslationResult.text(),
            wrapStrategy.getDisplayStart(),
            wrapStrategy.getDisplayEnd(),
