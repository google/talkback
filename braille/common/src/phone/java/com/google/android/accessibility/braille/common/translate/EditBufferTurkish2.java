...
/** An EditBuffer for Turkish Braille Grade 2. */
public class EditBufferTurkish2 extends EditBufferContracted {

  public EditBufferTurkish2(
  ...
  protected void fillTranslatorMaps(
    ...
    initialCharacterTranslationMap.put("16", "ç");
    ...
    initialCharacterTranslationMap.put("126", "ğ");
    ...
    initialCharacterTranslationMap.put("146", "ş");
