...
public class BrailleUserPreferencesTouchDots {
  ...
  public static List<PointF> readLayoutPointsPhone(
      Context context,
  ...
  public static void writeLayoutPointsPhone(
      Context context,
      SharedPreferences sharedPreferences,
      boolean isTableTop,
      int orientation,
    ...
    if (!pointsString.isEmpty()) {
      ...
      for (int i = 0; i < unorientedPoints.size(); i++) {
        ...
        if (savedOrientation == Configuration.ORIENTATION_PORTRAIT
          ...
          point = BrailleUtils.mapPortraitToLandscapeForPhone(point, oldScreenSize, screenSize);
        } else if (savedOrientation == Configuration.ORIENTATION_LANDSCAPE
            && orientation == Configuration.ORIENTATION_PORTRAIT) {
          point = BrailleUtils.mapLandscapeToPortraitForPhone(point, oldScreenSize, screenSize);
        }
        points.add(point);
      }
    }
  ...
  private BrailleUserPreferencesTouchDots() {}
}
