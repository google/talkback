...
/** Log handler which unifies logging under a single, BrailleCommon-specific tag. */
public final class BrailleCommonLog {
  private static final String TAG = "BrailleCommon";
