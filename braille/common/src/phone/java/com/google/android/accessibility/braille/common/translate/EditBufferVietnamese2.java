...
/** An EditBuffer for Vietnamese Braille Grade 2. */
public class EditBufferVietnamese2 extends EditBufferContracted {

  public EditBufferVietnamese2(
  ...
  protected void fillTranslatorMaps(
    ...
    initialCharacterTranslationMap.put("345", "ă");
    initialCharacterTranslationMap.put("16", "â");
    initialCharacterTranslationMap.put("2346", "đ");
    initialCharacterTranslationMap.put("126", "ê");
    initialCharacterTranslationMap.put("1456", "ô");
    initialCharacterTranslationMap.put("246", "ơ");
    initialCharacterTranslationMap.put("1256", "ư");
  }
