...
/** An EditBuffer for German Braille Grade 2. */
public class EditBufferGerman2 extends EditBufferContracted {

  public EditBufferGerman2(
  ...
  protected void fillTranslatorMaps(
    ...
    initialCharacterTranslationMap.put("345", "ä");
    initialCharacterTranslationMap.put("246", "ö");
    initialCharacterTranslationMap.put("2346", "ß");
    initialCharacterTranslationMap.put("1256", "ü");

    initialCharacterTranslationMap.put("16", "au");
    initialCharacterTranslationMap.put("126", "eu");
    initialCharacterTranslationMap.put("146", "ei");
    initialCharacterTranslationMap.put("1456", "ch");
    initialCharacterTranslationMap.put("156", "sch");
    initialCharacterTranslationMap.put("23456", "st");
    initialCharacterTranslationMap.put("34", "äu");
    initialCharacterTranslationMap.put("346", "ie");
  }
