...
public abstract class SeeAllActionsDialog extends ViewAttachedDialog {
  ...
  private enum Gestures {
    ...
    SWIPE_UP_ONE(R.drawable.swipe_up_one, R.string.gesture_move_cursor_backward),
    SWIPE_DOWN_ONE(R.drawable.swipe_down_one, R.string.gesture_move_cursor_forward),
