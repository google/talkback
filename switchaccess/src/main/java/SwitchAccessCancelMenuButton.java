...
/**
 * Menu button for "Cancel." As this button needs special handling during Option Scanning, any view
 * with this class name will be ignored.
 */
public class SwitchAccessCancelMenuButton extends SmallMenuButton {
  ...
  public SwitchAccessCancelMenuButton(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public SwitchAccessCancelMenuButton(Context context, AttributeSet attrs, int defStyleRes) {
